...
class PassiveTest(tk.Toplevel):
    ...
    def __init__(self, parent, channel, window):
        ...
        self.labelTop = tk.Label(self.frameTop, text='PASSIVE TEST', font=("Arial", 20, "bold", "italic"), bg='#d2e9fa')
                    ...
                    if not self.address:
                        ...
                        if not self.name or not correctName:
                            ...
                            with h5py.File(self.addressFile, "a") as f:
                                try:
                                    grp = f.require_group(self.group)
                                    dset = grp.create_dataset(self.name + "Params", (1, 2), dtype='S30')
    ...
    def progressBarFunction(self):
        ...
        progressBar = ProgressBar.ProgressBarClass(self, self.addressFile, self.name, self.group, "PassiveTest")
